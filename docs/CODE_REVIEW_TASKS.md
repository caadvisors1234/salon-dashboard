...
### - [x] TASK-006: バッチジョブのロケーション処理を並列化
...
### - [x] TASK-007: getClientSummaries のクエリ並列化
...
### - [x] TASK-008: PDF生成エンドポイントにユーザー単位レート制限を追加
...
### - [x] TASK-009: CSVアップロードのファイル内容検証を強化
...
### - [x] TASK-011: Supabaseダウン時のミドルウェアエラーハンドリング
...
### - [x] TASK-014: HPBデータ取得の select("*") を最適化
...
### - [x] TASK-015: ダッシュボードメトリクスAPIにキャッシュヘッダー追加
...
### - [x] TASK-016: PDFスクリーンショットの deviceScaleFactor を調整
...
### - [x] TASK-017: チャートコンポーネントに React.memo を適用
...
### - [x] TASK-020: ReportDialog のポーリングロジックをカスタムフックに分離
...
### - [x] TASK-021: APIエラーレスポンスからDB詳細を除去
...
### - [x] TASK-023: バッチジョブのサーキットブレーカーとデッドレターキュー
...
### - [x] TASK-025: rating_snapshots テーブルのインデックス確認・追加
...
### - [x] TASK-026: Content Security Policy (CSP) の設定
...
### - [x] TASK-028: React Suspense / Streaming の導入
